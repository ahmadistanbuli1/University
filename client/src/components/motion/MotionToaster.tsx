  ...
  return (
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            'rounded-2xl border border-zinc-200/90 bg-white/95 shadow-xl shadow-violet-500/10 backdrop-blur-md dark:border-white/10 dark:bg-zinc-900/95',
          title: 'font-semibold text-zinc-900 dark:text-white',
          description: 'text-zinc-600 dark:text-zinc-300',
          actionButton:
            'rounded-xl bg-violet-600 text-white font-semibold hover:bg-violet-700',
